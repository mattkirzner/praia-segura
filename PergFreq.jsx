...
import './PergFreq.css'; // Importe o arquivo de estilos CSS
...
const PergFreq = () => {
  return (
    <div className="perguntas-frequentes-container">
      ...
      <div className="pergunta">
        <h3>Em quais condições devo evitar completamente o banho de mar?</h3>
        <p>
      ...
      <div className="pergunta">
        <h3>O perigo é o mesmo em todo o trecho de risco? Existem áreas proibidas?</h3>
        <p>
      ...
      <div className="pergunta">
        <h3>O que devo fazer na hipótese de ataque?</h3>
        <p>
